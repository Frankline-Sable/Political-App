...
AnimatorSet set;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        set = (AnimatorSet) AnimatorInflater.loadAnimator(getActivity(), R.animator.blinky_fragment3);
        ...
        RelativeLayout layout = (RelativeLayout) getActivity().findViewById(R.id.layout3);
